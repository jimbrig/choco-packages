...
# Original Source: <https://github.com/majkinetor/chocolatey/blob/main/New-Package.ps1>
...
function New-Package{
    ...
    $nuspec = $nuspec -replace '<packageSourceUrl>.+', "<packageSourceUrl>https://github.com/$GithubRepository/tree/main/automatic/$id</packageSourceUrl>"
...
New-Package $Name $Type -GithubRepository jimbrig/choco-packages -Verbose -iconUrl $iconUrl -id $id