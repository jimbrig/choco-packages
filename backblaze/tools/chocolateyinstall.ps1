...
$url        = 'https://secure.backblaze.com/win32/install_backblaze.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'Backblaze' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
